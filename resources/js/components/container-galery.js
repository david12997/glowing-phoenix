        ...
        <div class="ContainerGalery screen-container">
            ...
            <div class="ContainerGalery__grid">
                ...
                <div class="Grid__fotos3">
                    <div class="GaleryGridContainer3"></div>
                </div>
                
                <div class="Grid__fotos4">
                    <div class="GaleryGridContainer4"></div>
                </div>
            </div>
            <br>
        </div>
...
export const JsContainerGalery = ()=>{
    ...
    const containerFotos3 = document.getElementsByClassName('GaleryGridContainer3'); 
    const containerFotos4 = document.getElementsByClassName('GaleryGridContainer4');

    const fotos1 = [
        '/assets/galery-page/cont1/img-1.png',
        '/assets/galery-page/cont1/img-2.png',
        '/assets/galery-page/cont1/img-3.png',
        '/assets/galery-page/cont1/img-4.png',
        '/assets/galery-page/cont1/img-5.png',
        '/assets/galery-page/cont1/img-6.png',
        '/assets/galery-page/cont1/img-7.png'
    ];

    const textFotos1 = [
        'Inner Deesire caratula',
        'Crizzo',
        'Ilustacion My Own Demon',
        'Sergio bajista',
        'Leo guitarrista',
        'Brayan baterista',
        'Los Glowing'
    ...
    const fotos2 = [
        '/assets/galery-page/cont3/img-1.png',
        '/assets/galery-page/cont3/img-2.png',
        '/assets/galery-page/cont3/img-3.png',
        '/assets/galery-page/cont3/img-4.png',
        '/assets/galery-page/cont3/img-5.png',
        '/assets/galery-page/cont3/img-6.png',
        '/assets/galery-page/cont3/img-7.png',
        '/assets/galery-page/cont3/img-8.png',
        '/assets/galery-page/cont3/img-9.png',
        '/assets/galery-page/cont3/img-10.png'
    ];

    const textFotos2 = [

        'Glowing Phoenix',
        'Grabación My Own Demon',
        'Concierto experimental',
        'Producciones Yisus',
        'Grabando My Own Demon',
        'Leo ganjael',
        'Yisus productor',
        'Grabando my own demon',
        'Crizzo',
    ...
    const fotos3 = [
        '/assets/galery-page/cont2/img-1.png',
        '/assets/galery-page/cont2/img-2.png',
        '/assets/galery-page/cont2/img-3.png',
        '/assets/galery-page/cont2/img-4.png',
        '/assets/galery-page/cont2/img-5.png',
        '/assets/galery-page/cont2/img-6.png',
        '/assets/galery-page/cont2/img-7.png',
        '/assets/galery-page/cont2/img-8.png'
    ...
    const fotos4 = [
        '/assets/galery-page/cont4/img-1.png',
        '/assets/galery-page/cont4/img-2.png',
        '/assets/galery-page/cont4/img-3.png',
        '/assets/galery-page/cont4/img-4.png',
        '/assets/galery-page/cont4/img-5.png',
        '/assets/galery-page/cont4/img-6.png',
        '/assets/galery-page/cont4/img-7.png',
        '/assets/galery-page/cont4/img-8.png',
        '/assets/galery-page/cont4/img-9.png',
        '/assets/galery-page/cont4/img-10.png'
    ];
    ...
    const textFotos4 = [
        ...
        'Leo tomine',
        'Brayan',
        'Toque experimental bar',
        'Produciendo música',
        'Brayan',
        'Brayan y Leo',
        'Glowing underground',
        'Desde tomine pora el mundo',
        'Ensayos'
    ];
    ...
    fotos3.forEach((element,index)=>{
        ...
        containerFotos3[0].insertAdjacentHTML('beforeend',CardFotos3);

    });


    let CardFotos4;
    fotos4.forEach((element,index)=>{
        ...
        containerFotos4[0].insertAdjacentHTML('beforeend',CardFotos4);
